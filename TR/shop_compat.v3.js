...
(function(){
  ...
  function ensureRockWrapper(){
    ...
    if (wrapper) return;
    var candidates = Array.from(document.querySelectorAll('[id*="rock" i], [class*="rock" i], img[src*="rock" i], img[alt*="rock" i], img[alt*="Jerry" i], [id*="petRock" i]'));
    
    if (candidates.length) {
      var best = candidates[0], bestArea = 0;
